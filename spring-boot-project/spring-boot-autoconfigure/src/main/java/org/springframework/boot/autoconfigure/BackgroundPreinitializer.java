 ...
 * foreground.
 *
 * ApplicationEnvironmentPreparedEvent: 这个监听器是开启一个后台线程来对一些类进行预初始化，因为这些类首次初始化比较慢，所以使用后台线程先预热效果更佳。
 * @see BackgroundPreinitializer#performPreinitialization()
 * 如果不想进行预热，可以设置 {@link #IGNORE_BACKGROUNDPREINITIALIZER_PROPERTY_NAME} 为 true 来关闭.
 *
 * @author Phillip Webb
