...
public class DispatcherServletAutoConfiguration {
	...
	/**
	 * 给配置类向 spring 容器中注入了 DispatcherServlet 组件
	 */
	@Configuration(proxyBeanMethods = false)
	...
	/**
	 * DispatcherServlet 的注册类
	 * 负责将 DispatcherServlet 注册到 servletContext 中，在 tomcat 启动时会调用项目工程下
	 * SpringServletContainerInitializer 中的 onStartUp 方法，将 dispatcherServlet 注册到 servletContext 中
	 */
	@Configuration(proxyBeanMethods = false)
