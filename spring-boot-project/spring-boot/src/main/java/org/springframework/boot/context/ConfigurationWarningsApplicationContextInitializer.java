 ...
 * mistakes.
 *
 * 向 Spring 容器中添加了一个 {@link ConfigurationWarningsPostProcessor} 这个后置处理器，这个后置处理器是
 * 对 {@link ComponentScan} 注解要扫描的包名进行 check，如果发现包名存在问题，则发出告警.
 *
 * Note: 错误的包名包括空的包名或 "org"、"org.springframework"
 *
 * @author Phillip Webb
 * @since 1.2.0
 */
public class ConfigurationWarningsApplicationContextInitializer
	...
	public void initialize(ConfigurableApplicationContext context) {
		// 向 Spring 容器中添加了一个 ConfigurationWarningsPostProcessor 这个后置处理器
