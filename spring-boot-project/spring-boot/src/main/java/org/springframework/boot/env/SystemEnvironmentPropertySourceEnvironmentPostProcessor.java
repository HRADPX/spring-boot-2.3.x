 ...
 *
 * 将环境中的 systemEnvironment 这个 propertySource 转换为 {@link OriginAwareSystemEnvironmentPropertySource} 用于替代
 * 原来的 {@link SystemEnvironmentPropertySource}， 用于追踪每个 systemEnvironment 属性.
 *
...
public class SystemEnvironmentPropertySourceEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
	...
	public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
		// 将 systemProperties 变量里的系统属性转换为 SystemEnvironmentPropertySource 替换原来的，主要用于追踪原环境变量
